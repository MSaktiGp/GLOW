...
@section('content')
    ...
    <section class="max-w-6xl mx-auto px-4 pb-10">
        ...
        <class="grid md:grid-cols-3 gap-6">
            @foreach([
            ['name' => 'Rachel Salsabila', 'slug' => 'rachel-salsabila', 'rating' => '5/5', 'img' => '../images/Instruktur8.jpg'],
            ['name' => 'Chalisa Cintia', 'slug' => 'chalisa-cintia', 'rating' => '4.6/5', 'img' => '../images/Instruktur9.jpg'],
            ['name' => 'Laura Moana', 'slug' => 'laura-moana', 'rating' => '4.3/5', 'img' => '../images/Instruktur10.jpg']
        ] as $coach)
            <div class="bg-white rounded-lg shadow p-4 text-center">
                ...
                <a href="{{ $coach['slug'] === 'rachel-salsabila' 
                            ? route('user.booked5') 
                            : route('user.booked', ['jenis' => 'tabata', 'coach' => $coach['slug']]) }}"
