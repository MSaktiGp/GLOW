            ...
            <div class="payment-box">
                ...
                <div class="va-box d-flex justify-content-between align-items-center flex-wrap mb-4">
                    <div class="d-flex align-items-center gap-2">
                        <img src="{{ asset('images/OVO.png') }}" alt="Logo OVO" style="height: 28px;">
                        <span class="fw-bold text-custom">OVO</span>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                ...
                <div class="payment-instruction">
                    <h6 class="text-custom fw-bold mb-3">Petunjuk Pembayaran via OVO</h6>
                    <ol>
                        <li>Buka aplikasi <strong>OVO</strong> dan login.</li>
                        <li>Pilih menu <strong>Transfer</strong></li>
                        <li>Pilih transfer ke salah satu rekening bank.</li>
                        <li>Masukkan kode pembayaran: <strong>128 0856 4318 1606</strong></li>
                        <li>Masukkan jumlah pembayaran: <strong>Rp150.000</strong></li>
                        <li>Konfirmasi dan masukkan <strong>PIN OVO</strong></li>
