...
@section('content')
    ...
    <section class="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div class="grid md:grid-cols-3 gap-6">
           @foreach([
            ['name' => 'Rebeca Laura', 'slug' => 'rebeca-laura', 'rating' => '5/5', 'img' => '../images/Instruktur9.jpg'],
            ['name' => 'Alisyah Aurel', 'slug' => 'alisyah-aurel', 'rating' => '4.5/5', 'img' => '../images/Instruktur6.jpg'],
            ['name' => 'Kayla Zahra', 'slug' => 'kayla-zahra', 'rating' => '4.8/5', 'img' => '../images/Instruktur1.jpg']
            ] as $coach)
            <div class="bg-white rounded-lg shadow p-4 text-center">
                ...
                <a href="{{ $coach['slug'] === 'rebeca-laura' 
                            ? route('user.booked3') 
                            : route('user.booked', ['jenis' => 'poundfit', 'coach' => $coach['slug']]) }}"
