...
<head>
    <meta charset="UTF-8">
    <title>Clases Tabata - GLOW</title>
...
<header class="bg-[#F189B8] py-4">
  <div class="flex items-center justify-between px-4">
    ...
    <img src="{{ asset('tabatafoto.jpg') }}" alt="Tabata Class" class="w-full h-[500px] object-cover rounded-md">
    </section>
    ...
    <section class="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            @foreach([
                ['name' => 'Rachel Salsabila', 'rating' => '5/5', 'img' => '../Instruktur1.jpg'],
                ['name' => 'Chalisa Cintia', 'rating' => '4.6/5', 'img' => '../Instruktur5.jpg'],
                ['name' => 'Laura Moana', 'rating' => '4.3/5', 'img' => '../Instruktur6.jpg']
            ] as $coach)
