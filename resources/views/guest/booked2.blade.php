...
<div class="container mt-5">
  <div class="row align-items-start bg-light p-4 rounded shadow-sm">
    ...
    <div class="col-md-8 text-custom">
      ...
      <p class="mb-1"><i class="bi bi-star-fill text-warning"></i> <strong>5/5</strong></p>
      <p class="fw-semibold mb-2"> <i class="bi bi-telephone-fill"></i> 081234567890</p>
      <p class="fw-semibold mb-2"> <i class="bi bi-instagram"></i> zahrakayla4_ </p>
      <p>"Ubah postur dan tingkatkan fleksibilitas Anda bersama Kayla, instruktur Pilates bersertifikat dengan pengalaman lebih dari 5 tahun dalam mengajarkan keselarasan tubuh dan gerakan yang anggun."</p>
    </div>
  </div>
</div>
        ...
        <div class="card shadow-sm class-card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <h5 class="card-title mb-1">Serene Core</h5>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm class-card">
          <div class="card-body">
            <span class="badge bg-success mb-2">Available</span>
            <div class="d-flex justify-content-between">
              <h5 class="card-title">Tranquil Motion</h5>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm class-card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <h5 class="card-title">Zenith Pilates</h5>
              <span class="text-muted">60 Menit</span>
            </div>
