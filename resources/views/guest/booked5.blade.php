...
<div class="container mt-5">
  <div class="row align-items-start bg-light p-4 rounded shadow-sm">
    <div class="col-md-4 text-center">
      <img src="{{ asset('images/Instruktur8.jpg') }}" alt="Instruktur Tabata" class="img-fluid rounded">
    </div>
    <div class="col-md-8 text-custom">
      <h4 class="fw-bold mb-1">Rachel Salsabila</h4>
      ...
      <p class="fw-semibold mb-2"> <i class="bi bi-instagram"></i> rachelS_ </p>
      <p>"Dorong batas dan capai hasil maksimal dalam waktu singkat bersama Rachel, instruktur Tabata bersertifikat dengan pengalaman lebih dari 5 tahun dalam memimpin sesi latihan intensitas tinggi yang membakar lemak dan meningkatkan stamina."</p>
    </div>
  </div>
</div>
...
<section class="py-5 px-5" style="background: #F189B8;">
  <div class="container text-center text-white">
    <h2 class="mb-3">Book a Tabata Class</h2>
    <p class="mb-4">Bergabunglah dengan kelas Tabata kami. Temukan waktu latihan yang tepat untuk Anda dan tingkatkan koneksi pikiran dan tubuh Anda.</p>
        ...
        <div class="card shadow-sm class-card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <h5 class="card-title mb-1">Core Velocity</h5>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm class-card">
          <div class="card-body">
            <span class="badge bg-success mb-2">Available</span>
            <div class="d-flex justify-content-between">
              <h5 class="card-title">Radiant Vorce</h5>
      ...
      <div class="col-md-4">
        <div class="card shadow-sm class-card">
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between">
              <h5 class="card-title">Grit & Grind</h5>
              <span class="text-muted">60 Menit</span>
            </div>
