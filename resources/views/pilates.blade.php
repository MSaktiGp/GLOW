...
<head>
    <meta charset="UTF-8">
    <title>Clases Pilates - GLOW</title>
...
<header class="bg-[#F189B8] py-4">
  <div class="flex items-center justify-between px-4">
    ...
    <img src="{{ asset('pilatesfoto.jpg') }}" alt="Pilates Class" class="w-full h-[500px] object-cover rounded-md">
    </section>
    ...
    <section class="max-w-6xl mx-auto px-4 pb-10">
        ...
        <div class="grid md:grid-cols-3 gap-6">
            @foreach([
                ['name' => 'Kayla Zahra', 'rating' => '5/5', 'img' => '../Instruktur3.jpg'],
                ['name' => 'Alisyah Aurel', 'rating' => '4.5/5', 'img' => '../Instruktur5.jpg'],
                ['name' => 'Rebeca Laura', 'rating' => '4/5', 'img' => '../Instruktur6.jpg']
            ] as $coach)
